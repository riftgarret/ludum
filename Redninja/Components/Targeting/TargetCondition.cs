namespace Redninja.Components.Targeting
{
	...
	public static class TargetConditions
	{
		...
		public static TargetCondition MustBeAlive { get; } = (t, u) => t.VolatileStats[CombatStats.HP] > 0;
		public static TargetCondition MustBeDead { get; } = (t, u) => t.VolatileStats[CombatStats.HP] <= 0;
